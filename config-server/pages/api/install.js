...
function scriptInstall() {
  return [
    ...
    '# com.apple.private.tcc.allow lets tccd grant every listed service natively',
    '# when SIP is disabled — no user dialogs or TCC.db rows needed.',
    ...
    '  || warn    "codesign failed — TCC.db grants still active"',
    'rm -f "$_TMP_ENT"',
    '',
